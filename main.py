...
class CustomerStorage:
    ...
    def __init__(self):
        self.conn = pg.connect(database='dz_netology', user='postgres', password='admin')
    ...
    def delete_phones(self, mail):
        ...
        delete_phones = list(map(int, input('Введите через запятую номера, которые хотите удалить: ').split(',')))
...
if __name__ == "__main__":
    ...
    start_logic_db.new_client_to_db('Иван', 'Иванов', 'ivan001@gmail.com')
    start_logic_db.new_client_to_db('Иван', 'Иванов', 'ivan002@gmail.com', '33355566, 21345756')
    start_logic_db.new_client_to_db('Иван', 'Иванов', 'ivan003@gmail.com', '1885530, 2153120, 5489787')
    start_logic_db.add_phone_to_client('ivan001@gmail.com', '118887777')
    start_logic_db.add_phone_to_client('ivan003@gmail.com', '333555789, 1779878456')
    start_logic_db.change_client('ivan001@gmail.com', 'Надежда', 'Светленькая', 'nadezhda@gmail.com')
    start_logic_db.change_client('2', new_name='Пётр', new_mail='petr@gmail.com')
    start_logic_db.delete_phones('nadezhda@gmail.com')
    start_logic_db.delete_phones('petr@gmail.com')
    start_logic_db.delete_phones('ivan003@gmail.com')
    start_logic_db.delete_client('ivan002@gmail.com')
    start_logic_db.get_info_client('ivan001@gmail.com')
